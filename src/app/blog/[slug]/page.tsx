...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <div className="relative min-h-screen text-[color:var(--text)]">
      ...
      <main className="flex flex-col gap-10 pb-12 pt-36 sm:pt-32">
        <section className="content-frame">
          <article className="space-y-8 text-left">
            <header className="glass-panel rounded-[36px] p-6 shadow-[var(--zl-shadow-soft)] sm:p-10">
              ...
              <p
                className="mt-4 max-w-3xl text-[16px] leading-[1.75] md:text-[18px]"
            ...
            >
              <div
                className="blog-prose-panel text-[16px] leading-[1.75] md:text-[18px] prose prose-lg max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-[color:var(--text)] prose-p:leading-[1.75] prose-p:text-[color:var(--reading-text)] prose-strong:text-[color:var(--text)] prose-a:text-[color:var(--brand)] prose-a:transition prose-a:duration-200 prose-a:hover:text-[color:var(--text)] prose-hr:border-[color:var(--glass-border)]"
        ...
        <MarketingFeatureCarousel
          ...
          subtitle="Explore what Zero Labs AI can deliver."
        />
